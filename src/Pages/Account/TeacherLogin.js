                ...
                <div className="card-body">
                    <div className='flex h-screen justify-center items-center'>
                        <div className="card w-96 bg-base-100 shadow-xl">
                            <div className="card-body">
                                <h2 className="text-center text-3xl font-bold mb-4">Teacher Login</h2>
                                ...
                                <p><small>New to TechoKids? <Link className='text-primary' to="/teacherSignUp">Create New Account</Link></small></p>
