                ...
                <div className="card-body">
                    <div className='flex h-screen justify-center items-center'>
                        <div className="card w-96 bg-base-100 shadow-xl">
                            <div className="card-body">
                                <h2 className="text-center text-3xl font-bold mb-4">Teacher Registration</h2>
                                ...
                                <p><small>Already Have an Account? <Link className='text-primary' to="/teacherLogin">Please Login</Link></small></p>
