        ...
        <div className="drawer drawer-mobile">
            ...
            <div className="drawer-side">
                ...
                <ul className="menu p-4 overflow-y-auto w-56 bg-base-300 font-bold">
                    ...
                    <li className='bg-success mt-4 rounded hover:text-white hover:bg-red '><Link to="/dashboard/courses">All Courses</Link></li>
                    <li className='bg-success mt-4 rounded hover:text-white hover:bg-red '><Link to="/dashboard/users">All Student</Link></li>
                </ul>
